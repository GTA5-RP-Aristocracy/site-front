...
<template>
	<div class="avatar">
		...
		>
			<div
				class="avatar__container-languages"
				:class="{ 'move-right': isMenuVisible }"
			>
				<img
					src="../assets/images/russia_flags_flag.png"
					alt="russian"
					@click="switchToRussian"
				/>
				<img
					src="../assets/images/united_kingdom_flag.png"
					alt="english"
					@click="switchToEnglish"
				/>
			</div>
			<div class="avatar__container-one" @click="showPopUp">
				{{ t('auth.signIn') }}
			</div>
			<div class="avatar__container-two" @click="$router.push('/registration')">
				{{ t('auth.signUp') }}
			</div>
		</div>
