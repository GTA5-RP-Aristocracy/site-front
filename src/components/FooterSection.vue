	...
	<div class="footer">
		...
		<div class="footer__link">
			<ul class="footer__link__list">
				...
				<li>
					<a href="https://discord.gg/K4QADYZx" target="_blank">{{
						t('nav.pages.discord')
					}}</a>
				</li>
				<li>
					<router-link to="/download">{{
						t('nav.pages.download')
					}}</router-link>
				</li>
			</ul>
		</div>
		...
		<div class="footer__follow">
			...
			<ul class="footer__follow__list">
				<li class="footer__follow__item">
					<a href="https://www.instagram.com/cykctacik/" target="_blank"
						>Instagram</a
					>
				</li>
				<li class="footer__follow__item">
					<a href="https://vk.com/spit_in_my_face891" target="_blank"
						>Vkontakte</a
					>
				</li>
				<li class="footer__follow__item">
				...
				<li class="footer__follow__item">
					<a href="https://www.youtube.com/@AzazinKreet" target="_blank"
						>Youtube</a
					>
				</li>
			</ul>
