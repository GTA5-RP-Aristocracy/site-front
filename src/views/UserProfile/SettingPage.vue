...
const language = ref<string>(
	languageStore.locale === 'ru' ? 'Русский' : 'English'
)
			...
			<div class="settings__inputs">
				...
				<ul class="settings__list">
					...
					<li class="settings__item">
						...
						<button @click="openNicknamePopup" class="edit-button">
							{{ t('settings.edit') }}
						</button>
					</li>
					<SettingsPopUpEmail
					...
					<li class="settings__item">
						...
						<button @click="openEmailPopup" class="edit-button">
							{{ t('settings.edit') }}
						</button>
					</li>
					...
					<li class="settings__item">
						...
						<button @click="openPasswordPopup" class="edit-button">
							{{ t('settings.edit') }}
						</button>
					</li>
					<li class="settings__item">
					...
					<li class="settings__item">
						...
						<button @click="openBioPopup" class="edit-button">
							{{ t('settings.edit') }}
						</button>
					</li>
					<SettingsPopUpRegion
					...
					<li class="settings__item">
						...
						<button @click="openRegionPopup" class="edit-button">
							{{ t('settings.edit') }}
						</button>
					</li>
					<li class="settings__item">
					...
					<li class="settings__item">
						...
						<button @click="switchLanguage" class="edit-button">
							{{ t('settings.edit') }}
						</button>
					</li>
				</ul>
